...
m=7;
p=5;
a= {2, 1, 5.5, 3, 1, 4, 1, 2, 4, -2, 2, 1, 5, 3, 1, 4, 4, -2, 1, 4, 4, -2, 1, 4, 4, -2, 0, 5, 3, 4, 6, 7, 9, 4, 0, 6, 4, 9, 3, 4, 2, 4, 5, 7, 6, 4, 2, 3, 5}
b= {2, 1, 5.5, 3, 1, 4, 1, 2, 4, -2, 2, 1, 5, 3, 1, 4, 4, -2, 2, 1, 5.5, 3, 1, 4, 1, 2, 4, -2, 2, 1, 5, 3, 1, 4, 4}
*/
...
int main(int argc, char *argv[])
{
  ...
  posix_memalign((void **)&a4, 128, 256 * sizeof(float));
  posix_memalign((void **)&b4, 128, 256 * sizeof(float));
  posix_memalign((void **)&c, 128, 256 * sizeof(float));
  posix_memalign((void **)&tmp, 128, 256 * sizeof(float));
  posix_memalign((void **)&output, 128, 256 * sizeof(float));

  posix_memalign((void **)&a42, 128, 256 * sizeof(float));
  posix_memalign((void **)&b42, 128, 256 * sizeof(float));
  posix_memalign((void **)&c2, 128, 256 * sizeof(float));
  posix_memalign((void **)&tmp2, 128, 256 * sizeof(float));
  posix_memalign((void **)&output2, 128, 256 * sizeof(float));
